...
Working through these artefacts changed the way I understand business process modelling. Before this topic I mostly thought process modelling was about drawing the steps of a process. I now realise that BPMN gives process diagrams a clear structure and makes activities, decisions, responsibilities and events easier for others to understand. I also learned that process models are useful for more than simply showing how work is completed. They can help organisations identify problems and find opportunities for improvement. The examples involving AI also showed me that modelling tools are becoming more advanced but human review is still important. Overall I now see business process modelling as a practical BPM tool for communication, analysis and process improvement.
